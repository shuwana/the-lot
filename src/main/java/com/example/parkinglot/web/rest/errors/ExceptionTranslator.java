...
import static com.example.parkinglot.config.Constants.SPRING_PROFILE_PRODUCTION;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        ...
        if (
            ex instanceof com.example.parkinglot.exception.EmailAlreadyUsedException
        ) return (ProblemDetailWithCause) new EmailAlreadyUsedException().getBody();
        if (
            ex instanceof com.example.parkinglot.exception.InvalidPasswordException
